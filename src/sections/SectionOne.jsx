...
export default function SectionOne() {
  return (
    <section className="relative w-full min-h-[600px] md:min-h-screen">
      ...
      <div className="relative flex flex-col items-center text-center text-white px-6 sm:px-12 md:px-24 lg:px-48 xl:px-64 py-16 sm:py-20 md:py-24 gap-10">
        ...
        {/* Caixa mais afastada do título */}
        <div className="mt-10 border backdrop-blur-sm rounded-2xl sm:rounded-3xl px-6 sm:px-8 md:px-12 py-6 sm:py-8 flex flex-col gap-3 text-base sm:text-lg md:text-2xl lg:text-4xl text-left max-w-6xl">
